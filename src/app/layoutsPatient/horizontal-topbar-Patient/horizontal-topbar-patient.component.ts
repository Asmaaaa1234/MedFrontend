...
@Component({
    selector: 'app-horizontal-topbar-patient',
    templateUrl: './horizontal-topbar-patient.component.html',
    standalone: false
})
export class HorizontalTopbarPatientComponent implements OnInit {
